...
class file_Core {
		...
		{
				$writeable = '<b class="vert">'.Kohana::lang( 'form.yes' ).'</b>';
				$unwriteable = '<b class="rouge">'.Kohana::lang( 'form.no' ).'</b>';

				return is_writable( $folder ) ? $writeable : $unwriteable;
		}
