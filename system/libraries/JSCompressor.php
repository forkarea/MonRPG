...
class	JSCompressor_Core	{

		private	$code;
		private	$exite	=	array(	);

		public	function	__construct(	$dirs,	$exite	=	false	)
		{
				if(	is_array(	$exite	)	)
						$this->exite	=	$exite;
		...
		{
				$packer	=	new	JavaScriptPacker_Core(	$this->code	);
...
class	JavaScriptPacker_Core	{
		...
		public	function	__construct(	$_script,	$_encoding	=	0,	$_fastDecode	=	true,	$_specialChars	=	false	)
		{
		...
		private	function	_bootStrap(	$packed,	$keywords	)
		{
				...
				$unpackPacker	=	new	JavaScriptPacker_Core(	$unpack,	0,	false,	true	);
