						...
						<tbody>
								...
								foreach( $config as $key => $row ):
										...
										<tr class="<?php echo $class; ?>">
												...
												<td><?php echo file::chmod( DOCROOT.'../modules/global/config/'.$row ); ?></td>
												<td><?php echo str_replace( 'admin/../', '', DOCROOT.'../modules/global/config/'.$row ); ?></td>
												<td><?php echo is_writable( DOCROOT.'../modules/global/config/'.$row ) ? html::anchor( 'config/update/'.str_replace( '.php', '', $row ), html::image( 'images/template/drawings.png', array( 'title' => Kohana::lang( 'form.edit' ), 'class' => 'icon_list' ) ) ) : FALSE; ?></td>
										</tr>
										<?php
										$n++;
								endforeach
