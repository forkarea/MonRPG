		...
		public function index()
		{
				...
				$this->template->contenu->menu = array( array( 'title' => Kohana::lang( 'menu.users' ),
						...
						array( 'title' => Kohana::lang( 'menu.map' ),
								...
								'img' => 'icon-48-map.png' ),
						array( 'title' => Kohana::lang( 'menu.item_ligth_game' ),
								'href' => url::base( TRUE ).'items',
								'img' => 'icon-48-install.png' ),
						array( 'title' => Kohana::lang( 'menu.sort_ligth_fight' ),
								'href' => url::base( TRUE ).'sorts',
								'img' => 'icon-48-spell.png' ),
				...
				$this->template->contenu->chmod_map = is_writable( DOCROOT.'../images/map/' );
