...
size_case = <?php echo Kohana::config( 'map.taille_case' ); ?>,
size_character_x = <?php echo Kohana::config( 'map.taille_character_x' ); ?>,
size_character_y = <?php echo Kohana::config( 'map.taille_character_y' ); ?>,
