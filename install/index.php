...
<pre>sudo chmod 777 cache logs css js images application/config admin/application/config modules/global/config modules/plugins/controllers modules/plugins/views modules/plugins/i18n images/background images/articles images/tilesets images/character images/faceset images/items images/modules images/sorts images/sorts_animate images/terrain images/map</pre>
<h2>Capture écran</h2>
...
<table class="list_table">
		...
		writableCell( 'modules/global/config' );
		...
		writableCell( 'images/tilesets' );
		writableCell( 'images/character' );
		writableCell( 'images/faceset' );
		writableCell( 'images/items' );
		writableCell( 'images/modules' );
		writableCell( 'images/sorts' );
		writableCell( 'images/sorts_animate' );
		writableCell( 'images/terrain' );
		writableCell( 'images/map' );
		?>
</table>
